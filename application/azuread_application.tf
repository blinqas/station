# Borrowed from 
# https://github.com/aztfmod/terraform-azurerm-caf/blob/main/modules/azuread/applications_v1/azuread_application.tf
resource "azuread_application" "app" {
  display_name                   = var.settings.application_name
