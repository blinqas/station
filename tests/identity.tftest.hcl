...
run "identity_pim_role_assignments" {
  module {
    source = "./"
  }
  ...
  # Assert PIM eligible role assignment exists
  assert {
  ...
  # Assert PIM active role assignment exists
  assert {
  ...
  # Assert non-PIM role assignment exists
  assert {
