...
export TF_VAR_subscription_ids="[\"efde04e6-789f-4c67-8f59-afd73496a267\"], [\"ad48532c-2bb1-45d2-bab4-aee4f484432a\"]" # Azure Subscriptions where Station should have owner permissions. Fetch using: az account list --query "[?tenantId=='yourTenantID'].{Name:name, ID:id}" --output table
